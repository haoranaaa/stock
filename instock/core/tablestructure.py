...
CN_STOCK_SECTOR_FUND_FLOW = (('行业资金流', '概念资金流'),
                             ({'name': 'stock_sector_fund_flow_rank', 'cn': '今日',
                               'columns': {'name': {'type': VARCHAR(20), 'cn': '名称', 'size': 70},
                                           'change_rate': {'type': FLOAT, 'cn': '今日涨跌幅', 'size': 70},
                                           'fund_amount': {'type': BIGINT, 'cn': '今日主力净流入-净额', 'size': 100},
                                           'fund_rate': {'type': FLOAT, 'cn': '今日主力净流入-净占比', 'size': 70},
                                           ...
                                           'fund_rate_small': {'type': FLOAT, 'cn': '今日小单净流入-净占比',
                                                               'size': 70},
                                           'stock_name': {'type': VARCHAR(20), 'cn': '今日主力净流入最大股',
                                                          'size': 70}}},
                              {'name': 'stock_individual_fund_flow_rank', 'cn': '5日',
                               'columns': {'name': {'type': VARCHAR(20), 'cn': '名称', 'size': 70},
                                           'change_rate_5': {'type': FLOAT, 'cn': '5日涨跌幅', 'size': 70},
                                           ...
                                           'fund_rate_small_5': {'type': FLOAT, 'cn': '5日小单净流入-净占比',
                                                                 'size': 70},
                                           'stock_name_5': {'type': VARCHAR(20), 'cn': '5日主力净流入最大股',
                                                            'size': 70}}},
                              {'name': 'stock_individual_fund_flow_rank', 'cn': '10日',
                               'columns': {'name': {'type': VARCHAR(20), 'cn': '名称', 'size': 70},
                                           'change_rate_10': {'type': FLOAT, 'cn': '10日涨跌幅', 'size': 70},
                                           ...
                                           'fund_rate_small_10': {'type': FLOAT, 'cn': '10日小单净流入-净占比',
                                                                  'size': 70},
                                           'stock_name_10': {'type': VARCHAR(20), 'cn': '10日主力净流入最大股',
                                                             'size': 70}}}))
...
TABLE_CN_STOCK_BUY_DATA = {'name': 'cn_stock_buy_data', 'cn': '持仓买入出策略',
                           'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                       'code': {'type': VARCHAR(6), 'cn': '代码', 'size': 60},
...
TABLE_CN_STOCK_POSITION = {'name': 'cn_stock_position', 'cn': '股票持仓',
                           'columns': {
                               ...
                               'code': {'type': VARCHAR(20), 'cn': '代码'},
                               'name': {'type': VARCHAR(50), 'cn': '名称'},
                               'market': {'type': VARCHAR(20), 'cn': '市场'},
                               'frozen_quantity': {'type': BIGINT, 'cn': '冻结数量'},
                               'unit_quantity': {'type': BIGINT, 'cn': '单位数量'},
                               'available_balance': {'type': FLOAT, 'cn': '可用余额'},
                               'actual_quantity': {'type': BIGINT, 'cn': '实际数量'},
                               'market_price': {'type': FLOAT, 'cn': '市价'},
                               'market_value': {'type': FLOAT, 'cn': '市值'},
                               'market_code': {'type': VARCHAR(20), 'cn': '市场代码'},
                               'opening_date': {'type': DATE, 'cn': '开仓日期'},
                               'cost_price': {'type': FLOAT, 'cn': '成本价'},
                               'cost_amount': {'type': FLOAT, 'cn': '成本金额'},
                               'break_even_price': {'type': FLOAT, 'cn': '保本价'},
                               'circulation_type': {'type': VARCHAR(20), 'cn': '流通类型'},
                               'profit_loss': {'type': FLOAT, 'cn': '盈亏'},
                               'profit_loss_ratio': {'type': FLOAT, 'cn': '盈亏比例'},
                               'account': {'type': VARCHAR(20), 'cn': '账户'},
                               'stock_balance': {'type': BIGINT, 'cn': '股票余额'},
                               'stock_category': {'type': VARCHAR(20), 'cn': '股票类别'},
                           }}

TABLE_CN_STOCK_ACCOUNT = {'name': 'cn_stock_account', 'cn': '股票账户',
                           'columns': {
                               'date': {'type': DATE, 'cn': '日期'},
                               'market_cap': {'type': VARCHAR(20), 'cn': '参考市值'},
                               'available_funds': {'type': VARCHAR(50), 'cn': '可用资金'},
